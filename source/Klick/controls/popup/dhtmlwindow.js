 ...
 function GetUrl()
        {
            ...
            if(String(window.location.hostname).indexOf("localhost") >=0 )
                url += "/netfame-website"
            return url;
        }

var dhtmlwindow={
imagefiles:[GetUrl() + '/images/popup/min.gif', GetUrl() + '/images/popup/btnClose.png', GetUrl() + '/images/popup/restore.gif', GetUrl() + '/images/popup/resize.gif'], //Path to 4 images used by script, in that order
...
init:function(t){
	...
	domwindowdata+='<div class="drag-statusarea"><div class="drag-resizearea" style=";">&nbsp;</div></div>'
	domwindowdata+='</div>'
...
open:function(t, contenttype, contentsource, title, attr, recalonload){
	...
	var ypos= '60px'//getValue("center")? "middle" : getValue("top") //Get y coord of window
...
load:function(t, contenttype, contentsource, title){ //loads content into window plus set its title (3 content types: "inline", "iframe", or "ajax")
	...
	if (contenttype=="inline")
		...
		if (!t.contentarea.firstChild || t.contentarea.firstChild.tagName!="IFRAME") //If iframe tag doesn't exist already, create it first
			t.contentarea.innerHTML='<iframe src="" style="margin:0; padding:0; border-style:none; width:100%; height: 100%" name="_iframe-'+t.id+'"></iframe>'
